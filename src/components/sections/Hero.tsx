          ...
          <div className="card-professional p-4 md:p-6 lg:p-8 backdrop-blur-md bg-white/5 border-white/10">
            ...
            <div className="flex justify-center items-center space-x-6 md:space-x-10 lg:space-x-12 text-white/70">
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
              >
                <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-0.5 md:mb-1">$5M+</div>
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
              >
                <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-0.5 md:mb-1">30+</div>
